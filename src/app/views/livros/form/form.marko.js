...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/aula_server$1.0.0/src/app/views/livros/form/form.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<html><body><h1>Cadastro de livro </h1><form action=/livros method=post>");

  if (data.livro.id) {
    out.w("<div><input type=hidden name=_method value=PUT></div>");
  }
...
marko_template.meta = {
    id: "/aula_server$1.0.0/src/app/views/livros/form/form.marko",
    tags: [
